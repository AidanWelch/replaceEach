 ...
 * @returns {string} String with first match of each searchValue replaced with respective replaceValues
 */

function replaceEach(originalString, searchValues, replaceValues) {
	...
	return parseString(originalString, matchers);
}
